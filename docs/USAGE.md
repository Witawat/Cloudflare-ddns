...
- **เช็คเวอร์ชันใหม่**: ตอนเริ่มโปรแกรม/service + ทุก 24 ชม. (มีเวอร์ชันใหม่ → log + แจ้ง Telegram 1 ครั้งต่อเวอร์ชัน ถ้าตั้งค่าไว้) + ทุกครั้งที่เปิดหน้าเว็บ (pill "มีเวอร์ชันใหม่")
