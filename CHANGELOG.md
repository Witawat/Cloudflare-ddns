...
- **ปุ่มปรับขนาดอักษร A−/A+** ที่หัวเว็บ (ข้างปุ่มภาษา): 3 ระดับ 100% / 125% / 150%
  (125% ≈ zoom 125% ของเบราว์เซอร์) — จำค่าไว้ใน localStorage (cfddns_fs)
  - พื้นฐานเดิม: ขนาดอักษรปรับตามความกว้างจออัตโนมัติอยู่แล้ว (clamp 14-17px)
  - ปุ่ม A−/A+ คูณทับอีกชั้น (--fs-scale) — เล็กสุด 100% · ใหญ่สุด 150%
