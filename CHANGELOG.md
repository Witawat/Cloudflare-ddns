...
- **หัวเว็บ (topbar) ล้นขอบบนมือถือ**: จอ ≤560px — brand + ปุ่ม 6 รายการ (สถานะ/เวอร์ชัน/ภาษา/
  ขนาดอักษร/รีเฟรช) กว้างเกินจอ → ล้นแนวนอน แก้: ลด padding, ซ่อน sub/verpill, จัด 2 แถว
  (แถว 1: สถานะ + รีเฟรช · แถว 2: ภาษา + A−/A+) — ยืนยัน 360px/320px ไม่ล้น, 1920px ปกติ
