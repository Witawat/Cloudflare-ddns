...
- **แถบสถานะ**หัวหน้า: พร้อมใช้งาน / ตั้งค่าไม่ครบ / มีปัญหา + **เวอร์ชันโปรแกรม** + แจ้งเตือนเมื่อมีเวอร์ชันใหม่ (GitHub — เช็คตอนเปิดหน้าเว็บ + ตอนเริ่มโปรแกรม/service แจ้ง Telegram ให้)
